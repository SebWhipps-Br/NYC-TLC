...
for month in range(1, 13):
    ...
    pickup_month = trips_df['lpep_pickup_datetime'].dt.month
    pickup_year = trips_df['lpep_pickup_datetime'].dt.year
    ...
    duplicate_time = trips_df['lpep_pickup_datetime'] != trips_df['lpep_dropoff_datetime']
