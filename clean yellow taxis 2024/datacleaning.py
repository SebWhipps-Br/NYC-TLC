...
for month in range(1, 13):
    ...
    trips_df.drop(['VendorID', 'store_and_fwd_flag', 'improvement_surcharge', 'mta_tax', 'extra', 'congestion_surcharge'], axis=1, inplace=True)
    ...
    pickup_month = trips_df['tpep_pickup_datetime'].dt.month
    pickup_year = trips_df['tpep_pickup_datetime'].dt.year
    ...
    duplicate_time = trips_df['tpep_pickup_datetime'] != trips_df['tpep_dropoff_datetime']
